        ...
        >
          ...
          >
            ...
            {index !== options.length - 1 && (
              <>
                <div
                  className={`absolute hidden 800px:block h-[65px] w-1   ${active + 1 > index ? "bg-blue-500" : "bg-[#384766]"
                    } bottom-[-150%]  `}
                />
                <div
                  className={`absolute 800px:hidden h-[2px]  w-[60px] ${active + 1 > index ? "bg-blue-500" : "bg-[#384766]"
